<?php
require_once('vista/layout/headerReserva.php');
?>
...
<div class="agregar">
    ...
    <a class="btn btn-primary" href="index.php?p=tablaReserva">Ver registro de reservas</a>
</div>
    ...
    <table class= "table"> 
        <thead class="thead-dark">
            <tr>
                ...
                <th scope="col">Numero de paquete</th>
                <th scope="col">Nombre de paquete</th>
                <th scope="col">Precio</th>
                <th scope="col">Cantidad Paquete</th>
        ...
        <tbody>
            ...
            foreach ($datos as $key => $value)
                foreach ($value as $valor):
                    ...
                    // Imprimir el precio formateado con el símbolo de la moneda
                    echo "<td>$".$precio_formateado."</td>";
                    
                    echo "<td>".$valor['cantidad_reservar']."</td>";

                    $total_personas = $valor['cantidad_reservar'] * $valor['num_personas'];
                    echo "<td>".$total_personas."</td>";// Mostrar el total calculado de personas

                    $total = $valor['precio'] * $valor['cantidad_reservar'];
                    $total_formateado = number_format($total, 2, ',', '.');
                    echo "<td>$".$total_formateado."</td>"; // Mostrar el total calculado de precio
