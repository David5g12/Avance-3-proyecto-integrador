<?php
require_once('vista/layout/headerDestallepaquete.php');
?>
<?php
...
<div class="agregar">
    <h1>Detalle de paquetes</h1>
    <a class="btn btn-primary" href="index.php?p=tabladestino">Ver registro de destino</a>
    <a class="btn btn-primary" href="index.php?p=tablapaquete">ver registros de paquetes</a>
</div>
        ...
        <tbody>
            ...
            foreach ($datos as $key => $value)
                foreach ($value as $valor):
                    ...
                    echo "<td>".$valor['nombre_destino']."</td>";
